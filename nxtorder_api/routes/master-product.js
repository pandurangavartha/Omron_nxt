...
// variants management
app.put('/:store_id/products/:product_id/category/:category_id/subcategory/:subcategory_id/variants', validator.validateHeaders, authorization.requiresLogin, uploadService.upload.array('images'), productController.addVariant);
app.post('/:store_id/products/:product_id/variants/:variant_id', validator.validateHeaders, authorization.requiresLogin, uploadService.upload.array('images'), productController.updateVariantDetails);
app.delete('/:store_id/products/:product_id/variants/:variant_id', validator.validateHeaders, authorization.requiresLogin, productController.removeVariant);
...
app.get('/products/:product_id/deactivate', validator.validateHeaders, authorization.requiresLogin, productController.deactivate);
app.get('/products/:product_id/activate', validator.validateHeaders, authorization.requiresLogin, productController.activate);
app.get('/products/:product_id', productController.view);
//app.get('/:store_id/products/:product_id', validator.validateHeaders, authorization.requiresLogin, productController.view);
app.post('/products/:product_id', validator.validateHeaders, authorization.requiresLogin, uploadService.upload.single('logo'), productController.update);
app.delete('/products/:product_id', validator.validateHeaders, authorization.requiresLogin, productController.delete);
app.get('/subcategory/:subCategory_id/products', validator.validateHeaders, authorization.requiresLogin, productController.products);
...
app.put('/master-products', validator.validateHeaders, authorization.requiresLogin, productController.register);
