...
const ProductRatingController = require('../api/controllers/product-rating.controller');
//const blogsLikesController = require('../api/controllers/blog-likes.controller');

app.post('/', validator.validateHeaders,authorization.requiresLogin, uploadService.bulkupload.array('image'), ProductRatingController.register);
